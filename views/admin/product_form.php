<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800"><?= isset($product) ? 'Cập nhật sản phẩm' : 'Thêm sản phẩm mới' ?></h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><?= isset($product) ? 'Cập nhật thông tin sản phẩm' : 'Nhập thông tin sản phẩm mới' ?></h6>
        </div>
        <div class="card-body">
            <form action="<?= isset($product) ? BASE_URL . 'admin/product/edit/' . $product['id'] : BASE_URL . 'admin/product/add' ?>" 
                ...
                <div class="row">
                    <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="price" name="price" 
                                               value="<?= isset($product) ? $product['price'] : '' ?>" min="0" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="discount" name="discount" 
                                               value="<?= isset($product) ? $product['discount'] : '0' ?>" min="0" max="100">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5"><?= isset($product) ? $product['description'] : '' ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <?php if (isset($product) && $product['image']): ?>
                                <div class="mt-2">
                                    ...
                                    <img src="<?= BASE_URL . 'uploads/' . $product['image'] ?>" alt="<?= $product['name'] ?>" class="img-thumbnail" style="max-width: 200px;">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status">
                                <option value="1" <?= isset($product) && $product['status'] == 1 ? 'selected' : '' ?>>Còn hàng</option>
                                <option value="0" <?= isset($product) && $product['status'] == 0 ? 'selected' : '' ?>>Hết hàng</option>
                            </select>
                        </div>
